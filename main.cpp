...
void modRobotByValue(Robot r, int b) {
    r.setBatteryLife(b);
}

// Step 3: Function to modify robot (pass by reference)
void modRobotByRef(Robot &r, int b) {
    r.setBatteryLife(b);
}
...
int main() {
    ...
    Robot myRobot = Robot("Melina", "human", 100);
